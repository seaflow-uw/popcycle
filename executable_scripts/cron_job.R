...
par(mfrow=c(2,2),mar=c(2,2,2,2), oma=c(1,1,3,3),cex=cex)
...
png("~/fluo_comp.png",width=15,height=9,unit='in',res=300)
par(mfrow=c(2,1),mar=c(2,2,2,2), oma=c(1,1,3,3),cex=cex)
