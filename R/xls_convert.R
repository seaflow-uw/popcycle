...
xls_convert <- function(db, meta, path) {
    ...
    dataset_meta_data <- dplyr::tibble(
                          ...
                          dataset_references = 'Ribalet F, Berthiaume C, Hynes A, Swalwell J and Armbrust EV. SeaFlow data 1.0, high-resolution abundance, size and biomass of small phytoplankton in the NE Pacific Ocean. submitted to ScientificData'
                          )
