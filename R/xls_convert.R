...
xls_convert <- function(db, meta, path) {
    ...
    vars_meta_data <- dplyr::tibble(
                          ...
                          var_comment = c(rep('none',4),
                                          ...
                                          'mean cellular carbon content based on the equation fgC cell-1 = 0.261 x Volume^0.860, where Volume is calculated from the lower bound of cell diameter, assuming spherical particle; see https://github.com/armbrustlab/fsc-poc-calibration for more details.',
                                          'mean cellular carbon content based on the equation fgC cell-1 = 0.261 x Volume^0.860, where Volume is calculated from the middle value of cell diameter, assuming spherical particle; see https://github.com/armbrustlab/fsc-poc-calibration for more details.',
                                          'mean cellular carbon content based on the equation fgC cell-1 = 0.261 x Volume^0.860, where Volume is calculated from the upper bound of cell diameter, assuming spherical particle; see https://github.com/armbrustlab/fsc-poc-calibration for more details.',
